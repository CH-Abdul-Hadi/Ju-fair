...
import { Target, Eye, Heart, Shield, Users, Sparkles, CheckCircle2 } from "lucide-react";
          ...
          <ScrollReveal direction="left">
            <div>
              ...
              <div className="mt-8 space-y-5 text-[17px] text-muted-foreground leading-[1.7]">
                <p>
                  JU Fair Global was founded to bridge the gap between international manufacturers and highly qualified buyers. 
                  Over three decades, we have meticulously built a proprietary database, a global sales force, and a proven matchmaking practice serving organizers in every major industry vertical.
                </p>
                <p>
                  Today, we operate across 40+ countries. Our core philosophy is simple: we don't just sell space, we deliver measurable ROI through targeted buyer recruitment and premium exhibition sales representation.
                </p>
              </div>
            ...
            {[
              {
                icon: Target,
                title: "Our Mission",
                desc: "To connect exhibitors with the right buyers through data-driven matchmaking and international representation that delivers measurable results. We turn global potential into actual trade.",
              },
              {
                icon: Eye,
                title: "Our Vision",
                desc: "To be the world's most trusted partner for international trade exhibitions and buyer matchmaking, setting the industry standard for ROI and lead quality.",
              },
            ].map((card, i) => (
              <ScrollReveal key={card.title} delay={i * 150} direction="up">
                <div className="card-elevated group p-10 h-full bg-white relative overflow-hidden">
                  ...
                  <card.icon size={160} className="absolute -bottom-10 -right-10 text-primary/[0.03] transition-transform duration-500 group-hover:scale-110 group-hover:text-primary/[0.05]" />
      ...
      <section className="section-pad bg-white">
        <div className="container-x">
          ...
          <div className="grid gap-6 md:grid-cols-3 mt-16">
            {[
              { icon: Shield,   title: "Integrity",   desc: "Transparent processes and completely honest reporting on leads." },
              { icon: Users,    title: "Partnership", desc: "We prioritize long-term collaboration over short-term gains." },
              { icon: Sparkles, title: "Excellence",  desc: "Elevated standards in every single engagement we undertake." },
              { icon: Heart,    title: "Client First",desc: "Your ROI and success is our ultimate measure of success." },
              { icon: Target,   title: "Precision",   desc: "Data-driven targeting ensures only highly qualified leads." },
              { icon: Eye,      title: "Insight",     desc: "Deep market knowledge applied across all industry verticals." },
            ].map((v, i) => (
        ...
        <div className="container-x relative z-10">
          <ScrollReveal>
            <div className="text-center">
              <p className="eyebrow inline-block">Milestones</p>
              <h2 className="text-[38px] font-bold text-white leading-[1.2] mt-2">Our Timeline</h2>
              <p className="mt-4 text-[18px] text-white/70 leading-[1.6] max-w-2xl mx-auto">A legacy of bridging international markets.</p>
          ...
          <div className="mt-20 relative">
            ...
            <div className="grid gap-12 md:gap-6 md:grid-cols-4 relative z-10">
              {[
                { year: "1990", t: "Founded", d: "Established as an international representation firm." },
                { year: "2000", t: "Global Expansion", d: "Opened offices across Europe and Asia." },
                { year: "2010", t: "Digital Matching", d: "Launched proprietary buyer-matching platform." },
                { year: "2020", t: "40+ Countries", d: "Reached full global coverage with 3000+ active buyers." },
              ].map((e, i) => (

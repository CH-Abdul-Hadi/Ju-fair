            ...
            {[
              {
                icon: Target,
                title: "Our Mission",
                desc: "To connect exhibitors with the right buyers through data-driven matchmaking and international representation that delivers measurable results.",
              },
              {
                icon: Eye,
                title: "Our Vision",
                desc: "To be the world's most trusted partner for international trade exhibitions and buyer matchmaking.",
              },
            ].map((card, i) => (
              <ScrollReveal key={card.title} delay={i * 100}>
                <div className="card-elevated group p-9 h-full">
      ...
      <section className="section-pad">
        <div className="container-x">
          ...
          <div className="grid gap-6 md:grid-cols-3 mt-10">
            {[
              { icon: Shield,   title: "Integrity",   desc: "Transparent processes and honest reporting." },
              { icon: Users,    title: "Partnership",  desc: "Long-term collaboration over short-term gains." },
              { icon: Sparkles, title: "Excellence",   desc: "Elevated standards in every engagement." },
              { icon: Heart,    title: "Client First", desc: "Your ROI is our measure of success." },
              { icon: Target,   title: "Precision",    desc: "Data-driven targeting for qualified leads." },
              { icon: Eye,      title: "Insight",      desc: "Deep market knowledge across verticals." },
            ].map((v, i) => (
              <ScrollReveal key={v.title} delay={i * 100}>
                <div className="card-elevated group text-center p-9 h-full">
        ...
        <div className="container-x">
          ...
          <div className="mt-12 max-w-3xl mx-auto relative">
            ...
            {[
              ...
              /* Alternating slide-in direction per entry */
              <ScrollReveal
                key={e.year}
                direction={i % 2 === 0 ? "left" : "right"}
                delay={i * 120}
              >
                <div className="relative md:grid md:grid-cols-2 md:gap-10 mb-10 items-center">
